            ...
            items: [
                {
                    ...
                    ballonBody: [
                        '<address>',
                        '<strong>Главный учебный корпус</strong>',
                        '<br/>',
            ...
            items: [
                {
                    ...
                    name: "Спорткомплекс МГТУ"
                },
                {
                    center: [55.774299, 37.700995],
                    ballonBody: [
                        '<address>',
                        '<strong>ULK</strong>',
                        '<br/>',
            ...
            items: [
                {
                    ...
                    name: "Большой зал центра креативных индустрий (БЗЦКИ)"
                },
                {
                    center: [55.764901, 37.682062],
                    ballonBody: [
                        '<address>',
                        '<strong>ULK</strong>',
                        '<br/>',
                    ...
                    name: "Поликлиника МГТУ и Бухгалтерия"
                }
            ]
        }
    ];
