...
function init() {
    // экземпляр карты
    var otherMap = new ymaps.Map("map", {
            center: [55.768096, 37.686517],
            zoom: 16
        }, {
    ...
    function createMenuGroup (group) {
        ...
        otherMap.geoObjects.add(collection);
...
//            });
            .add("click", function(e){
                otherMap.setCenter(e.get('target').geometry.getCoordinates(), 17, {duration: 1000});
            });
    ...
    //otherMap.setCenter([55.769697, 37.691681], 15, {checkZoomRange: true});
}
