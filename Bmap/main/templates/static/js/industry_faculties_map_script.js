...
function init() {
    // экземпляр карты
    var industryMap = new ymaps.Map("map", {
            center: [55.846411, 37.804677],
            zoom: 11
        }, {
    ...
    function createMenuGroup (group) {
        ...
        industryMap.geoObjects.add(collection);
    ...
    function createSubMenu(item, collection, submenu) {
        ...
        placemark.events
            ...
            .add('mouseenter', function (e) {
                e.get('target').options.set('preset', 'islands#redScienceIcon');
            })
...
//            });
            .add("click", function(e){
                industryMap.setCenter(e.get('target').geometry.getCoordinates(), 17, {duration: 1000});
        ...
        submenuItem
            ...
            .bind('click', function () {
                if (!placemark.balloon.isOpen()) {
                    placemark.options.set('preset', 'islands#redScienceIcon');
    ...
    //industryMap.setCenter([55.769697, 37.691681], 15, {checkZoomRange: true});
}
